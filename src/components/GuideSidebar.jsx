...
import { BookOpen, Zap, ChevronRight, ChevronDown, Play, Sparkles, Compass, Search, Lightbulb } from 'lucide-react';
...
export default function GuideSidebar({
  ...
  // Ambil semua kasus dari semua stages untuk mode Algopedia / Search
  const allCases = GUIDE_STAGES.flatMap(s => s.cases.map(c => ({ ...c, stageTitle: s.title, stageId: s.id })));
      ...
      <div className="p-4 border-b border-slate-800/80 flex flex-col gap-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h2 className="text-sm font-bold text-white tracking-wide">Panduan Rubik 5x5</h2>
              <p className="text-[11px] text-slate-400">Metode Reduksi & Kasus Parity</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-1 bg-slate-800/80 p-1 rounded-lg text-[10px] font-semibold">
            ...
            <button
              ...
              title="Sorot hanya blok pusat 3x3"
            >
              Pusat
            </button>
            <button
                ...
                >
                  ...
                  >
                    <div className="flex items-center gap-2.5">
                      <span className="w-6 h-6 rounded-full bg-slate-800 text-sky-400 border border-slate-700 flex items-center justify-center text-xs font-bold group-hover:border-sky-400 transition-colors">
                        {sIdx + 1}
                      </span>
                      <div>
                        ...
                        <span className="text-[10px] text-slate-400 line-clamp-1">{stage.summary}</span>
                      </div>
                    </div>
                    {isExpanded ? (
                      ...
                      <div className="space-y-2.5 pt-2">
                        ...
                        {stage.cases.map(cs => (
                          ...
                          >
                            ...
                            {/* Algorithm Monospace Pill */}
                            <div className="bg-slate-900 border border-slate-700/80 rounded-lg p-2 font-mono text-xs font-bold text-amber-300 flex items-center justify-between gap-2 mb-2">
                              <span className="tracking-wide">{cs.algorithm}</span>
                            </div>
          ...
          <div className="space-y-3">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="Cari kasus, rumus, kata kunci..."
            ...
            <div className="space-y-2.5">
              {filteredCases.map(cs => (
                ...
                >
                  ...
                  <p className="text-[11px] text-slate-400 leading-normal">{cs.summary}</p>
                  
                  <div className="bg-slate-900 border border-slate-700/80 rounded-lg p-2 font-mono text-xs font-bold text-amber-300">
                    {cs.algorithm}
                  </div>
